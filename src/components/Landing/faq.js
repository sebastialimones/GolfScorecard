...
const questions = [
    ...
    { id: 6, title: '¿Cómo sigo?' , answer: '1º-En el menú (arriba a la derecha), crea un nuevo campo. 2º-Ponle un nombre. 3º-Añade el handicap del campo y el tuyo propio. Ahora ya puedes incluir tu primer resultado'  },
];
